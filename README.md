# Homework 2 - *CoderSnap*

**CoderSnap** is a Ruby on Rails blog application that allows users to send messages to each other that can only be read once.
...
There are many things to do in a short time.
